...
const services = [
    {
        ...
        description: 'Trigger n8n workflows to generate LinkedIn content drafts automatically with AI — tailored to your brand voice.',
    },
    {
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth={1.5}>
        ...
        description: 'Browse, review, and manage all your LinkedIn content drafts pulled live from Airtable in one clean interface.',
    },
    {
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth={1.5}>
        ...
        description: 'Track and manage your email outreach campaigns sourced from Airtable with real-time status updates.',
    },
    {
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth={1.5}>
        ...
        description: 'Seamlessly connect to n8n workflows for email and content automation without writing a single line of code.',
    },
    {
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth={1.5}>
        ...
        description: 'A live two-way sync with Airtable keeps your data fresh — no manual imports or CSV uploads needed.',
    },
    {
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth={1.5}>
        ...
        description: 'Full authentication with 2FA and passkey (WebAuthn) support — your automation data stays private.',
    },
];
...
const reasons = [
    {
        ...
        description: 'Built with Laravel 13, React 19, and Inertia.js — the latest battle-tested stack for modern web applications.',
    },
    {
        title: 'Tailored Solutions',
        description: 'Every feature is purpose-built for your LinkedIn and email automation workflow — no bloat, no compromise.',
    },
    {
        title: 'Transparent Process',
        description: 'Real-time data from Airtable means you always see the latest state of your content and outreach pipelines.',
    },
    {
        title: 'Long-term Partnership',
        description: 'Soft Pyramid stands behind every product we ship, with ongoing support as your business scales.',
    },
];
                ...
                <section className="relative overflow-hidden px-6 pb-24 pt-20 text-center">
                    ...
                    <div className="relative mx-auto max-w-4xl">
                        ...
                        <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-gray-400">
                            Manage LinkedIn content drafts and email outreach workflows in one place —
                            powered by Airtable data and n8n automation pipelines.
                        </p>
                    ...
                    <div className="mx-auto max-w-6xl">
                        <div className="mb-14 text-center">
                            ...
                            <p className="mx-auto max-w-xl text-gray-500">
                                A unified portal built to streamline your LinkedIn content pipeline and email outreach — end to end.
                            </p>
                        </div>
                ...
                <section className="border-t border-white/[0.06] bg-white/[0.02] px-6 py-24">
                    <div className="mx-auto max-w-6xl">
                        ...
                        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                            {reasons.map((r, i) => (
                                <div key={r.title} className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-6">
                ...
                <footer className="border-t border-white/[0.06] px-6 py-8">
                    <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 text-sm text-gray-600 sm:flex-row">
                        ...
                        <div className="flex items-center gap-6">
                            <a href="https://softpyramid.com/" target="_blank" rel="noreferrer" className="transition hover:text-gray-400">
                                softpyramid.com
                            </a>
                            <span>© {new Date().getFullYear()} Soft Pyramid LLC</span>
                        </div>
                    </div>
                </footer>
